...
<html>
   ...
   <body style="padding:0" onload="setTimeout('init(<?php echo "$mjpegmode, $video_fps, $divider" ?>);', 100);">
   <!-- <div class="navbar navbar-inverse navbar-fixed-top" role="navigation" <?php getdisplayStyle('navbar', $userLevel); ?>>
      ...
      <div class="container-fluid text-center liveimage" >
         <div><img id="mjpeg_dest" style="width:82%"  <?php echo getLoadClass() . getImgWidth();?>
